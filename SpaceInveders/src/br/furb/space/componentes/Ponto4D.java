...
public final class Ponto4D {
	...
	public static double getDistanciaPontos(double ptoX1, double ptoY1, double ptoX2, double ptoY2){
		return Math.sqrt(Math.pow(ptoX2 - ptoX1, 2) + Math.pow(ptoY2 - ptoY1, 2));
	}
